...
SWIFT_USER_DOMAIN_NAME = AUTH_TOKENS.get('SWIFT_USER_DOMAIN_NAME')
SWIFT_USER_DOMAIN_ID = AUTH_TOKENS.get('SWIFT_USER_DOMAIN_ID')
SWIFT_PROJECT_DOMAIN_NAME = AUTH_TOKENS.get('SWIFT_PROJECT_DOMAIN_NAME')
SWIFT_PROJECT_DOMAIN_ID = AUTH_TOKENS.get('SWIFT_PROJECT_DOMAIN_ID')
SWIFT_USE_TEMP_URLS = AUTH_TOKENS.get('SWIFT_USE_TEMP_URLS', False)
SWIFT_TEMP_URL_KEY = AUTH_TOKENS.get('SWIFT_TEMP_URL_KEY')
SWIFT_AUTO_CREATE_CONTAINER = AUTH_TOKENS.get('SWIFT_AUTO_CREAT_CONTAINER', False)
SWIFT_AUTO_CREATE_CONTAINER_PUBLIC = AUTH_TOKENS.get('SWIFT_AUTO_CREAT_CONTAINER_PUBLIC', False)
